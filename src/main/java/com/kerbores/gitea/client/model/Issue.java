...
public class Issue {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assignee, assignees, body, closedAt, comments, createdAt, dueDate, htmlUrl, id, labels, milestone, number, originalAuthor, originalAuthorId, pullRequest, repository, state, title, updatedAt, url, user);
  }
