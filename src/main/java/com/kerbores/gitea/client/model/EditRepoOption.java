...
public class EditRepoOption {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(allowMergeCommits, allowRebase, allowRebaseExplicit, allowSquashMerge, archived, defaultBranch, description, externalTracker, externalWiki, hasIssues, hasPullRequests, hasWiki, ignoreWhitespaceConflicts, internalTracker, name, _private, template, website);
  }
